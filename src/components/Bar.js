        ...
        <div className={classes.root}>
            ...
            <Toolbar>
                ...
                <Button onClick = {(e) => {
                      ...
                      style={{ marginRight: '3%', marginLeft: '3%', color:"#fff9a3", textTransform: 'none', fontSize: '28px' }} >GitBook</Button>
                   
                <Button onClick = {(e) => {
                    e.preventDefault();
                    window.location.href='https://medium.com/@cerberusdao/welcome-to-cerberusdao-the-first-decentralized-reserve-currency-that-harnesses-the-power-of-e9c2a722e7f';
                    }} 
                    style={{ marginRight: '3%', color:"#fff9a3", textTransform: 'none', fontSize: '28px' }} className="btn-grad">Medium</Button>
                  <Button onClick = {(e) => {
                    e.preventDefault();
                    window.location.href='https://twitter.com/DaoCerberus';
                    }} 
