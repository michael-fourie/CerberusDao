        ...
        <div className={classes.root}>
            ...
            <Toolbar>
                ...
                <Button onClick = {(e) => {
                    ...
                    style={{ marginLeft: '3%', marginRight: '3%', color:"#fff9a3", textTransform: 'none', fontSize: '24px' }} className="btn-grad">Medium</Button>
                  <Button onClick = {(e) => {
                    e.preventDefault();
                    window.location.href='https://twitter.com/DaoCerberus';
                    }} 
                     style={{ marginRight: '3%', color:"#fff9a3", textTransform: 'none', fontSize: '24px' }} className="btn-grad">Twitter</Button>
                  <Button  onClick = {(e) => {
                    e.preventDefault();
                    window.location.href='https://t.co/EP6ouOP5Tv?amp=1';
                    }} 
                     style={{ marginRight: '3%', color:"#fff9a3", textTransform: 'none', fontSize: '24px' }} className="btn-grad">Discord</Button>
                </Toolbar>  
}
            </AppBar>
        </div>
