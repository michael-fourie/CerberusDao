            ...
            {isMobile ?
                ...
                <p className="barTitle">Cerberus DAO</p>
                  ...
                  <Button onClick = {(e) => {
                      ...
                      style={{ marginLeft: '0.5%', marginRight: '2%', color:"#fff9a3", textTransform: 'none', fontSize: '16px' }} >GitBook</Button> 
                  <Button onClick = {(e) => {
                    e.preventDefault();
                    ...
                    style={{ marginLeft: '0.5%', color:"#fff9a3", textTransform: 'none', fontSize: '16px' }} >Medium</Button>
                  <Button onClick = {(e) => {
                    e.preventDefault();
                    window.location.href='https://twitter.com/DaoCerberus';
                    }} 
                     style={{ marginRight: '0.5%', color:"#fff9a3",textTransform: 'none', fontSize: '16px' }} >Twitter</Button>
                  <Button  onClick = {(e) => {
                    e.preventDefault();
                    window.location.href='https://t.co/EP6ouOP5Tv?amp=1';
                    }} 
                     style={{color:"#fff9a3", textTransform: 'none',fontSize: '16px' }} >Discord</Button>
                </Toolbar>
            :
            <Toolbar>
                <Box display='flex' flexGrow={1}>   
