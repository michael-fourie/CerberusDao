...
function River() {
    ...
    return (
        <div>
            ...
            <p className="river-text">The river being the powerful memes which have taken the crypto-sphere by storm, while dwarfing DeFi bluechips far and wide. A discrepancy with other OHM forks is the use of stable-coin pairs which are utilized as a singular treasury asset. CerebrusDAO will harness the unique power of the meme economy to fuel our treassury.</p>
