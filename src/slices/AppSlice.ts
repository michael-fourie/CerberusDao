...
`;
        ...
        const ohmCirculatingSupply = parseFloat(graphData.data.protocolMetrics[0].ohmCirculatingSupply);
...
interface IAppData {
    readonly ohmCirculatingSupply: number;
    readonly sOhmCirculatingSupply?: number;
    readonly ohmStakedRate?: number;
